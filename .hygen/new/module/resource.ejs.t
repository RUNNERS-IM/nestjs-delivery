---
to: "src/modules/<%= h.filename(name) %>/admins/<%= h.resourceFileName(name) %>.ts"
unless_exists: true
---
<%
  // Class
...
// Option
import { <%= resourceOptionsName %> } from './options/<%= resourceOptionsFileName %>';

// Main section
export const <%= resourceName %> = {
  resource: <%= EntityName %>,
  options: <%= resourceOptionsName %>,
};
